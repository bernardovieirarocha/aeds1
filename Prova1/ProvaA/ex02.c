// Escreva um algoritmo que encontre e mostre o maior e o menor número negativo dentre todos
...
int main(void){
	...
	for (int i = 0 ; i < 100; i++){
		...
		if (num < menor && num < 0 && num >= -1000) { // Reforça as condições de recebimento do número
